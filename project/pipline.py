...
def copy_to_data(fullPath2File:str) -> str:
...
if __name__=='__main__':
    flightpth=copy_to_data(download_dataset('zernach/2018-airplane-flights'))
    weatherpth=copy_to_data(download_dataset('behroozbc/average-day-weather-for-2018'))
    resultdf=transform(read_file(flightpth),read_file(weatherpth))
    clean([flightpth,weatherpth])
